...
* It is often accessible for free and publicly online on platforms like [arXiv](https://arxiv.org) and [HAL](https://hal.science).
...
* It consists of a desktop client compatible with Windows and Linux, alongside a browser extension to save an article from [arXiv](https://arxiv.org) or [HAL](https://hal.science) in a single click.
...
*Hyper Articles en Ligne*, the French equivalent of [arXiv](https://arxiv.org). It is a national repository open to everyone for depositing preprints, research papers, theses, etc.
...
### [Core Conference Portal](https://www.core.edu.au)
